...
alias bubo='HOMEBREW_NO_UPDATE_REPORT_NEW=1 brew update && brew outdated'
alias bubc='HOMEBREW_NO_UPDATE_REPORT_NEW=1 brew upgrade && brew cleanup'
alias bubu='HOMEBREW_NO_UPDATE_REPORT_NEW=1 bubo && bubc && brew doctor'
...
alias php8.3='echo "🐘 Switch PHP version to 8.3..." && { brew unlink shivammathur/php/php@8.4 && brew link shivammathur/php/php@8.3 -f -q --overwrite } &> /dev/null && php -v'
alias php8.4='echo "🐘 Switch PHP version to 8.4..." && { brew unlink shivammathur/php/php@8.3 && brew link shivammathur/php/php@8.4 -f -q --overwrite } &> /dev/null && php -v'
...
alias ineen="ssh deployment@ineen"
