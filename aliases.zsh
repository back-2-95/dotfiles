...
alias m='make'
alias php8.0='echo "🐘 Switch PHP version..." && { brew unlink php@8.1 php@8.2 && brew link php@8.0 -f -q --overwrite } &> /dev/null && php -v'
alias php8.1='echo "🐘 Switch PHP version..." && { brew unlink php@8.0 php@8.2 && brew link php@8.1 -f -q --overwrite } &> /dev/null && php -v'
alias php8.2='echo "🐘 Switch PHP version..." && { brew unlink php@8.0 php@8.1 && brew link php@8.2 -f -q --overwrite } &> /dev/null && php -v'
alias ls="exa"
